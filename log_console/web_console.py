...
def gen_command():
	...
	return 'tail -n100 %s |awk -f trimcells.awk' % (log_file)
...
class Console:
	...
	def POST(self):
		...
		titles = [u'EventID', u'logtime', u'AppID', u'UID', u'SDK Ver', u'ChannelID', u'Game Ver', u'IMEI', u'IDFA', u'AccountID', u'ServerID', u'RoleLevel', u'RoleID', u'RoleName',]
		return render_template('list.html', headers=titles, records=raws, cmd=cmd)
