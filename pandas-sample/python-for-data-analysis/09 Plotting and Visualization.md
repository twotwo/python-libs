...
![图9-2 带有三个subplot的Figure](./img/09_02.png)
...
![图9-4 继续绘制两次之后的图像](./img/09_04.png)
...
---------|----------
 nrows | subplot 的行数
 ncols | subplot 的列数
 sharex | subplot 全局x轴刻度
 sharey | subplot 全局x轴刻度
 subplot_kw | 创建 subplot 的关键字字典
 **fig_kw | 创建 figure 的其它关键字，如 plt.subplots(2,2,figsize=(8,6))
...
![图9-5 各subplot之间没有间距](./img/09_05.png)
...
![图9-7 不同drawstyle选项的线型图](./img/09_07.png)
...
![图9-8 用于演示xticks的简单线型图（带有标签）](./img/09_08.png)
...
![图9-9 用于演示xticks的简单线型图](./img/09_09.png)
...
![图9-10 带有三条线以及图例的简单线型图](./img/09_10.png)
...
![图9-11 2008-2009年金融危机期间的重要日期](./img/09_11.png)
